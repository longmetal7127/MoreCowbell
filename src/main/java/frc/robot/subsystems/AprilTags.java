...
public class AprilTags extends SubsystemBase {
  ...
  public void camInit() {
    ...
    visionThread = new Thread(() -> {
        ...
        quadThresholdParameters.minClusterPixels = 80; // pixel size
        quadThresholdParameters.criticalAngle *= 5; // default is 10
        quadThresholdParameters.maxLineFitMSE = 5;
        quadThresholdParameters.minWhiteBlackDiff = 40;
